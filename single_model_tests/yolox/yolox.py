...
# 加载模型 model = fd.vision.megvii.YOLOX("yolox_s.onnx")
...
evaluation = fd.vision.evaluation.eval_detection(model, 0.001, 0.65, "/huangjianhui/fastdeploy_test/data/coco/val2017.txt")
print(evaluation)
